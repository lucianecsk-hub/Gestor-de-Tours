        ...
        <div className="no-print max-w-5xl mx-auto px-3 sm:px-4 py-4 space-y-6">
          <div className="bg-white rounded-lg border border-slate-200 p-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-3">
                <Field label="Extras - Descrição"><input className={inputCls} value={form.extrasDescricao} onChange={e=>setForm({...form,extrasDescricao:e.target.value})}/></Field>
                <Field label="Extras - Valor ($)"><input type="number" className={inputCls} value={form.extrasValor} onChange={e=>setForm({...form,extrasValor:e.target.value})}/></Field>
              </div>
                    ...
                    return (
                      <React.Fragment key={e.id}>
                        ...
                        {num(e.extrasValor) > 0 && (
                          <tr className="text-slate-500">
                            <td></td>
                            <td className="py-1">{dataFmt}: {e.extrasDescricao || 'Extras'}</td>
                            <td className="py-1 text-right">{money(num(e.extrasValor))}</td>
                            <td className="py-1 text-right">{money(num(e.extrasValor))}</td>
                            <td></td>
                          </tr>
                        )}
